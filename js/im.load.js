...
(function() {
	...
	var dependencies = [
		...
		['sizzle.js', function() { return (typeof window['Sizzle'] != 'undefined'); }],
	...
	(loadDep = function(depPos) {
		...
		if(!dep[1]()) {
			...
			newdep.onload = function() { loadDep(depPos + 1); };
			newdep.onreadystatechange = function () {
				if (/loaded|complete/.test(this.readyState)) loadDep(depPos + 1);
			};
