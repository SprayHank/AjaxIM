...
(function($) {
	...
	$.extend($.jStore, {
		...
		setCurrentEngine: function(name) {
			// If no instances exist, attempt to load one
			if(!$.jStore.Instances.length)                return $.jStore.FindEngine();
...
function flash_ready() { $.jStore.delegate.trigger('flash-ready');}
/*!
